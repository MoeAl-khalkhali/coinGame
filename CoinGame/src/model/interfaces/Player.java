...
/**
 * <pre>
 *  Assignment interface for Further Programming representing the player
 ...
 * 
 * <b>NOTE:</b> playerID is unique and if another player with same id is added it replaces the previous player
 * </pre>
 * 
 * @author Caspar Ryan
 * 
...
public interface Player
{
	...
	/**
	 * @param points
	 *            - for betting (updated by GameEngineImpl via BetType enum with
	 *            each win or loss)
	 */
	...
	/**
	 * @param betType
	 *            - enum representing the type of bet being placed
	 */
	...
	/**
	 * reset the bet to 0 for next round and set betType to NO_BET (in case player
	 * does not bet again in next round)
	 */
	public abstract void resetBet();

	/**
	 * @return a CoinPair containing final coin values as set by
	 *         {@link Player#setResult(CoinPair)}
	 */
	 ...
	 * 
	 *            <pre>
	 * a CoinPair containing final coin values (updated from the GameEngine 
	 *            {@link GameEngine#spinPlayer(Player, int, int, int, int, int, int)})
	 *            </pre>
	 */
